INSERT INTO pessoa(nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo)
  VALUES('Luiz Gustavo', 'Rua Rosinha Sigaud', '1348', NULL, 'Caiçara Adelaide', '30.770-560', 'Belo Horizonte', 'MG', TRUE);

INSERT INTO pessoa(nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo)
  VALUES('João', 'Rua A', '123', NULL, 'Céu Azul', '30.122-153', 'Belo Horizonte', 'MG', TRUE);

INSERT INTO pessoa(nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo)
  VALUES('Maria', 'Rua B', '2', 'Bloco A', 'Horto', '30.770-560', 'Rio de Janeiro', 'RJ', TRUE);
